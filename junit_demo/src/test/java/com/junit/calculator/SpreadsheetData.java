...
public class SpreadsheetData {
    ...
    public SpreadsheetData(final InputStream excelInputStream)
            throws IOException, com.sun.media.sound.InvalidFormatException, InvalidFormatException {
    ...
    private Collection<Object[]> loadFromSpreadsheet(final InputStream excelFile)
            throws IOException, com.sun.media.sound.InvalidFormatException, org.apache.poi.openxml4j.exceptions.InvalidFormatException {
